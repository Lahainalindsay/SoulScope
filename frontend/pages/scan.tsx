...
export default function ScanIntroPage() {
  ...
  return (
    <>
      <Head>
        <title>SoulScope Resonance Scan</title>
        ...
        <main className={styles.shell}>
          <section className={styles.introStage}>
            ...
            <div className={styles.heroPanel}>
              <p className={styles.eyebrow}>SoulScope Resonance Scan</p>
              <h1 className={styles.title}>Let your voice mirror the state of your system.</h1>
              <p className={styles.lead}>
                Find a quiet space, face the camera, and answer each prompt naturally.
              </p>
