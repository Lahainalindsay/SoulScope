        ...
        <section className={styles.heroWrap}>
          <div className={styles.heroPanel}>
            <div className={styles.heroCopy}>
              ...
              <p className={styles.heroLead}>Your inner world is always expressing itself.</p>
              ...
              <div className={styles.heroActions}>
                <Link href="/auth/login" className={styles.primaryCta}>Begin Your Resonance Scan</Link>
