...
export const SCAN_OVERVIEW_LINES = [
  "Begin with one steady sound, then answer a few simple prompts.",
  "Speak naturally. There are no right answers.",
  "SoulScope observes changes in timing, steadiness, expression, and vocal balance.",
...
export const GUIDED_SCAN_QUESTIONS: GuidedScanQuestion[] = [
  {
    id: "sustained_vowel",
    title: "Prompt 1",
    rangeLabel: "Settle In",
    prompt: "Take a breath, then hold an ahhh or ohhh sound for five seconds.",
    rationale: "Creates a steady voice sample for comparison.",
    durationMs: 5000,
  ...
  },
  {
    id: "simple_joy",
    title: "Prompt 2",
    rangeLabel: "Everyday Life",
    prompt: "What is something you genuinely enjoy doing?",
    rationale: "Invites natural, low-pressure expression.",
    durationMs: 10000,
  ...
  },
  {
    id: "liked_in_people",
    title: "Prompt 3",
    rangeLabel: "Connection",
    prompt: "What do you appreciate most about the people in your life?",
    rationale: "Invites reflection through connection and appreciation.",
    durationMs: 10000,
    captureKind: "guided_speech",
  },
  {
    id: "current_weight",
    title: "Prompt 4",
    rangeLabel: "What Is Present",
    prompt: "What has been taking up the most space in your mind lately?",
    rationale: "Brings current demand into the conversation.",
    durationMs: 10000,
    captureKind: "guided_speech",
  },
  {
    ...
    title: "Prompt 5",
    rangeLabel: "Feeling",
    prompt: "How has that been feeling for you?",
    rationale: "Invites emotional language without asking for a rating.",
    durationMs: 10000,
    captureKind: "guided_speech",
  },
  {
    ...
    title: "Prompt 6",
    rangeLabel: "Body",
    prompt: "Where do you notice that feeling in your body?",
    rationale: "Brings attention to present body awareness.",
    durationMs: 10000,
    captureKind: "guided_speech",
  },
  {
    id: "goal_dream",
    title: "Prompt 7",
    rangeLabel: "Looking Forward",
    prompt: "What is something you would love to move toward next?",
    rationale: "Closes with direction and possibility.",
    durationMs: 10000,
    captureKind: "guided_speech",
  },
];
