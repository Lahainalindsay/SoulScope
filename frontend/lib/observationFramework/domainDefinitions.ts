...
export const DOMAIN_DEFINITIONS: DomainDefinition[] = [
  ...
  },
  {
    ...
    orientation: "availability",
    observations: [
      { id: "expressive_variability_observation", weight: 0.38, positiveDirection: "elevated" },
      { id: "speech_dynamics_observation", weight: 0.24, positiveDirection: "elevated" },
      { id: "response_consistency_observation", weight: 0.18, positiveDirection: "elevated" },
      { id: "vocal_stability_observation", weight: 0.12, positiveDirection: "elevated" },
      { id: "harmonic_clarity_observation", weight: 0.08, positiveDirection: "elevated" },
    ],
    minimumObservationCount: 2,
  ...
  },
  {
    ...
    observations: [
      ...
      { id: "expressive_variability_observation", weight: 0.25, positiveDirection: "elevated" },
      { id: "speech_dynamics_observation", weight: 0.22, positiveDirection: "elevated" },
      { id: "vocal_output_activation", weight: 0.16, positiveDirection: "elevated" },
      { id: "regulation_steady_observation", weight: 0.12, positiveDirection: "elevated" },
    ],
    minimumObservationCount: 2,
