...
export const OBSERVATION_DEFINITIONS: ObservationDefinition[] = [
  ...
  { id: "response_consistency_observation", label: "Current response consistency", version: OBSERVATION_RULE_VERSION, requiredEvidence: ["response_consistency"], optionalEvidence: ["vocal_stability"], minimumEvidenceAgreement: 1, summary: (direction) => direction === "elevated" ? "Responses appear relatively consistent across the available signal." : direction === "reduced" ? "Response consistency appears reduced." : "Response consistency appears mixed.", alternatives: ["Prompt differences and recording conditions may affect consistency."], calculate: single("response_consistency") },
