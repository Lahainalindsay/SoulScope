    ...
    const diagnosticsResponse = await client.from("scan_interpretation_diagnostics").upsert(
      {
        ...
        evidence_ledger: args.report.canonicalResult.evidenceLedger,
        dimension_ledger: canonical.dimensionLedger,
        decision_ledger: args.report.canonicalResult.decisionLedger,
        subpattern_scores: args.report.atlas.result.subpatterns,
